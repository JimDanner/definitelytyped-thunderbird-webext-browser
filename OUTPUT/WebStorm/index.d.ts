...
declare namespace messenger {
	...
	namespace cloudFile {
		 ...
		 * @param tab The tab where the upload was initiated. Currently only available for the message composer.
		 */
		const onFileUploadAbort: WebExtEvent<
		 ...
		 * @param tab The tab where the upload was initiated. Currently only available for the message composer.
		 */
		const onFileDeleted: WebExtEvent<
			(account: CloudFileAccount, fileId: number, tab: tabs.Tab) => void
		>;
	...
	namespace compose {
		...
		const onActiveDictionariesChanged: WebExtEvent<
	...
	namespace folders {
		 ...
		 */
		const onFolderInfoChanged: WebExtEvent<
	...
	namespace mailTabs {
		...
		const onDisplayedFolderChanged: WebExtEvent<
			(tab: tabs.Tab, displayedFolder: folders.MailFolder) => void
		>;

		/** Fired when the selected messages change in any mail tab. */
		const onSelectedMessagesChanged: WebExtEvent<
	...
	namespace messageDisplay {
		 ...
		 */
		const onMessagesDisplayed: WebExtEvent<
	...
	namespace messages {
		...
		const onUpdated: WebExtEvent<
			(message: MessageHeader, changedProperties: MessageProperties) => void
		>;
		...
		const onNewMailReceived: WebExtEvent<

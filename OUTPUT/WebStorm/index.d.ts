...
declare namespace messenger {
    ...
    namespace _manifest {
        ...
        /**
         * Defines additional color, image and property keys to be used in {@link theme.ThemeType}, extending the theme-able areas of Thunderbird.
         */
        interface ThemeExperiment {
            /**
             * URL to a stylesheet introducing additional CSS variables, extending the theme-able areas of Thunderbird. The `theme_experiment add-on in our example repository <https: github.com="" thundernest="" sample-extensions="" tree="" master="" theme_experiment="">`__ is using the stylesheet shown below, to add the ``--chat-button-color`` CSS color variable: [theme_experiment_style.css](https://raw.githubusercontent.com/thundernest/webext-docs/latest-mv2/includes/theme/theme_experiment_style.css)The following _manifest.json_ file maps the --chat-button-color CSS color variable to the theme color key ``exp_chat_button`` and uses it to set a color for the chat button: [theme_experiment_manifest.json](https://raw.githubusercontent.com/thundernest/webext-docs/latest-mv2/includes/theme/theme_experiment_manifest.json)</https:>
             */
        ...
        interface ThemeType {
            /**
             * A _dictionary object_ with one or more _key-value_ pairs to map images to theme image keys. The following built-in theme image keys are supported:
             */
            images?: _ThemeTypeImages | undefined;
            /**
             * A _dictionary object_ with one or more _key-value_ pairs to map color values to theme color keys. The following built-in theme color keys are supported:
             */
            colors?: _ThemeTypeColors | undefined;
            /**
             * A _dictionary object_ with one or more _key-value_ pairs to map property values to theme property keys. The following built-in theme property keys are supported:
             */
        ...
        interface _WebExtensionManifestCloudFile {
            /**
             * Enable browser styles in the ``management_url`` page. See the MDN documentation on browser styles  for more information.
             */
            browser_style?: boolean | undefined;
            /**
             * This property is no longer used. The only supported data format for the ``data`` argument in {@link cloudFile.onFileUpload} is {@link File}.
             * @deprecated This property is no longer used. The only supported data format for the ``data`` argument in {@link cloudFile.onFileUpload} is {@link File}.
             */
            data_format?: string | undefined;
            /**
             * If a previously uploaded cloud file attachment is reused at a later time in a different message, Thunderbird may use the already known ``url`` and ``templateInfo`` values without triggering the registered {@link cloudFile.onFileUpload} listener again. Setting this option to ``false`` will always trigger the registered listener, providing the already known values through the ``relatedFileInfo`` parameter of the {@link cloudFile.onFileUpload} event, to let the provider decide how to handle these cases.
             */
            ...
            /**
             * This property is no longer used. The ``service_url`` property of the {@link cloudFile.CloudFileTemplateInfo} object returned by the {@link cloudFile.onFileUpload} event can be used to add a _Learn more about_ link to the footer of the cloud file attachment element.
             * @deprecated This property is no longer used. The ``service_url`` property of the {@link cloudFile.CloudFileTemplateInfo} object returned by the {@link cloudFile.onFileUpload} event can be used to add a _Learn more about_ link to the footer of the cloud file attachment element.
             */
        ...
        type _ThemeTypeColorScheme = 'light' | 'dark' | 'auto' | 'auto' | 'light' | 'dark' | 'system';

        /** If set, overrides the color scheme for the content area. */
        type _ThemeTypeContentColorScheme = 'light' | 'dark' | 'auto' | 'auto' | 'light' | 'dark' | 'system';
        ...
        type _PermissionPrivileged = 'activityLog' | 'mozillaAddons' | 'networkStatus' | 'telemetry';
    ...
    namespace accounts {
        /* accounts types */
        /**
         * An object describing a mail account, as returned for example by the {@link accounts.list} and {@link accounts.get} methods. The ``folders`` property is only included if requested.
         */
         ...
         * @param [includeFolders] Specifies whether the returned {@link accounts.MailAccount} objects should included their account's folders. Defaults to ``true``.
         */
        function list(includeFolders?: boolean): Promise<MailAccount[]>;
    ...
    namespace addressBooks {
        ...
        type NodeType = 'addressBook' | 'contact' | 'mailingList';
        ...
        function create(properties: _CreateProperties): Promise<string>;

        /** Renames an address book. */
        function update(id: string, properties: _UpdateProperties): Promise<any>;
        ...
        const onCreated: WebExtEvent<(node: AddressBookNode) => void>;

        /** Fired when an address book is renamed. */
        const onUpdated: WebExtEvent<(node: AddressBookNode) => void>;
        ...
        namespace provider {
            ...
            interface _OnSearchRequestParameters {
            ...
            interface _AddressBooks_providerOnSearchRequestEvent<
            ...
            /**
             * Registering this listener will create and list a read-only address book in Thunderbird's address book window, similar to LDAP address books. When selecting this address book, users will first see no contacts, but they can search for them, which will fire this event. Contacts returned by the listener callback will be displayed as contact cards in the address book. Several listeners can be registered, to create multiple address books. The event also fires for each registered listener (for each created read-only address book), when users type something into the mail composer's _To:_ field, or into similar fields like the calendar meeting attendees field. Contacts returned by the listener callback will be added to the autocomplete results in the dropdown of that field. Example: [onSearchRequest.js](https://raw.githubusercontent.com/thundernest/webext-docs/latest-mv2/includes/addressBooks/onSearchRequest.js)
             * @param [searchString] The search text that the user entered. Not available when invoked from the advanced address book search dialog.
             * @param [query] The boolean query expression corresponding to the search. **Note:** This parameter may change in future releases of Thunderbird.
             */
            const onSearchRequest: _AddressBooks_providerOnSearchRequestEvent;
        }
    }
    ...
    namespace contacts {
         ...
         * @param queryInfo Either a _string_ with one or more space-separated terms to search for, or a complex {@link contacts.QueryInfo} search query.
         */
        function quickSearch(queryInfo: string | QueryInfo): Promise<ContactNode[]>;
        /**
         * Gets all contacts matching ``queryInfo`` in the address book with the id ``parentId``.
         * @param parentId The id of the address book to search. If not specified, all address books are searched.
         * @param queryInfo Either a _string_ with one or more space-separated terms to search for, or a complex {@link contacts.QueryInfo} search query.
         */
        function quickSearch(parentId: string, queryInfo: string | QueryInfo): Promise<ContactNode[]>;
         ...
         * @param [id] Assigns the contact an id. If an existing contact has this id, an exception is thrown. **Note:** Deprecated, the card's id should be specified in the vCard string instead.
         * @param properties The properties object for the new contact. If it includes a ``vCard`` member, all specified legacy properties  are ignored and the new contact will be based on the provided vCard string. If a UID is specified in the vCard string, which is already used by another contact, an exception is thrown. **Note:** Using individual properties is deprecated, use the ``vCard`` member instead.
         */
        function create(parentId: string, id?: string, properties: ContactProperties): Promise<string>;

        /**
         * Updates a contact.
         * @param properties An object with properties to update the specified contact. Individual properties are removed, if they are set to ``null``. If the provided object includes a ``vCard`` member, all specified legacy properties  are ignored and the details of the contact will be replaced by the provided vCard. Changes to the UID will be ignored. **Note:** Using individual properties is deprecated, use the ``vCard`` member instead.
         */
        ...
        const onCreated: WebExtEvent<(node: ContactNode) => void>;

        /** Fired when a contact is changed. */
        const onUpdated: WebExtEvent<(node: ContactNode, changedProperties: PropertyChange) => void>;

        /** Fired when a contact is removed from an address book. */
        const onDeleted: WebExtEvent<(parentId: string, id: string) => void>;
    }
    ...
    namespace mailingLists {
        ...
        function create(parentId: string, properties: _CreateProperties): Promise<string>;
        ...
        function listMembers(id: string): Promise<contacts.ContactNode[]>;
        ...
        const onCreated: WebExtEvent<(node: MailingListNode) => void>;

        /** Fired when a mailing list is changed. */
        const onUpdated: WebExtEvent<(node: MailingListNode) => void>;

        /** Fired when a mailing list is deleted. */
        const onDeleted: WebExtEvent<(parentId: string, id: string) => void>;

        /** Fired when a contact is added to the mailing list. */
        const onMemberAdded: WebExtEvent<(node: contacts.ContactNode) => void>;

        /** Fired when a contact is removed from the mailing list. */
        const onMemberRemoved: WebExtEvent<(parentId: string, id: string) => void>;
    }

    /**
     * Manifest keys: `action`, `browser_action`, `action`, `browser_action`
     *
     * Not supported on manifest versions above 2.
     *
     * Not allowed in: Content scripts, Devtools pages
    ...
    namespace cloudFile {
        ...
        interface CloudFileTemplateInfo {
            /**
            ...
            /**
             * A URL pointing to a web page of the used cloud file service. Will be used in a _Learn more about_ link in the footer of the cloud file attachment element.
             */
            service_url?: string | undefined;
            /**
         ...
         * If set, the cloud file entry for this upload will include a hint, that the link will only be available for a limited time.
         */
        interface _CloudFileTemplateInfoDownloadExpiryDate {
         ...
         * @param tab The tab where the upload was initiated. Currently only available for the message composer.
         * @param [relatedFileInfo] Information about an already uploaded file, which is related to this upload.
         */
        const onFileUpload: WebExtEvent<
            (
                ...
                /**
                 * Set this to ``true`` if the file upload was aborted by the user and an {@link cloudFile.onFileUploadAbort} event has been received. No error message will be shown to the user.
                 */
         ...
         * @param tab The tab where the upload was initiated. Currently only available for the message composer.
         */
        const onFileUploadAbort: WebExtEvent<(account: CloudFileAccount, fileId: number, tab: tabs.Tab) => void>;
         ...
         * @param tab The tab where the rename was initiated. Currently only available for the message composer.
         */
        const onFileRename: WebExtEvent<
            (
                account: CloudFileAccount,
                fileId: number,
                newName: string,
         ...
         * @param tab The tab where the upload was initiated. Currently only available for the message composer.
         */
        const onFileDeleted: WebExtEvent<(account: CloudFileAccount, fileId: number, tab: tabs.Tab) => void>;

        /**
         * Fired when a cloud file account of this add-on was created.
         * @param account The created account.
         */
        const onAccountAdded: WebExtEvent<(account: CloudFileAccount) => void>;

        /**
         * Fired when a cloud file account of this add-on was deleted.
         * @param accountId The id of the removed account.
         */
        const onAccountDeleted: WebExtEvent<(accountId: string) => void>;
    }
    ...
    namespace compose {
        ...
        /**
         * A _dictionary object_ with entries for all installed dictionaries, having a language identifier as _key_ (for example ``en-US``) and a boolean expression as _value_, indicating whether that dictionary is enabled for spellchecking or not.
         */
        interface ComposeDictionaries {
            [key: string]: boolean;
        }
        ...
        type _BeginForwardForwardType = 'forwardInline' | 'forwardAsAttachment';

        /** The used send mode. */
        type _SendMessageReturnReturnMode = 'sendNow' | 'sendLater';

        interface _SendMessageReturnReturn {
            /** The used send mode. */
        ...
        type _SendMessageOptionsMode = 'default' | 'sendNow' | 'sendLater';
        ...
        /** The used save mode. */
        type _SaveMessageReturnReturnMode = 'draft' | 'template';

        interface _SaveMessageReturnReturn {
            /** The used save mode. */
        ...
        type _SaveMessageOptionsMode = 'draft' | 'template';

        interface _SaveMessageOptions {
            mode: _SaveMessageOptionsMode;
        }

        /** The used send mode. */
        type _OnAfterSendSendInfoMode = 'sendNow' | 'sendLater';

        interface _OnAfterSendSendInfo {
            /** The used send mode. */
        ...
        /* compose functions */
        /**
         * Open a new message compose window. **Note:** The compose format can be set by ``details.isPlainText`` or by specifying only one of ``details.body`` or ``details.plainTextBody``. Otherwise the default compose format of the selected identity is used. **Note:** Specifying ``details.body`` and ``details.plainTextBody`` without also specifying ``details.isPlainText`` threw an exception in Thunderbird up to version 97\. Since Thunderbird 98, this combination creates a compose window with the compose format of the selected identity, using the matching ``details.body`` or ``details.plainTextBody`` value. **Note:** If no identity is specified, this function is using the default identity and not the identity of the referenced message.
         */
        function beginNew(): Promise<tabs.Tab>;
        /**
         * Open a new message compose window. **Note:** The compose format can be set by ``details.isPlainText`` or by specifying only one of ``details.body`` or ``details.plainTextBody``. Otherwise the default compose format of the selected identity is used. **Note:** Specifying ``details.body`` and ``details.plainTextBody`` without also specifying ``details.isPlainText`` threw an exception in Thunderbird up to version 97\. Since Thunderbird 98, this combination creates a compose window with the compose format of the selected identity, using the matching ``details.body`` or ``details.plainTextBody`` value. **Note:** If no identity is specified, this function is using the default identity and not the identity of the referenced message.
         ...
         * Open a new message compose window. **Note:** The compose format can be set by ``details.isPlainText`` or by specifying only one of ``details.body`` or ``details.plainTextBody``. Otherwise the default compose format of the selected identity is used. **Note:** Specifying ``details.body`` and ``details.plainTextBody`` without also specifying ``details.isPlainText`` threw an exception in Thunderbird up to version 97\. Since Thunderbird 98, this combination creates a compose window with the compose format of the selected identity, using the matching ``details.body`` or ``details.plainTextBody`` value. **Note:** If no identity is specified, this function is using the default identity and not the identity of the referenced message.
         */
        function beginNew(details: ComposeDetails): Promise<tabs.Tab>;
        ...
        /**
         * Updates the compose window. Only fields that are to be changed should be specified. Currently only a limited amount of information can be set, more will be added in later versions. **Note:** The compose format of an existing compose window cannot be changed. Since Thunderbird 98, setting conflicting values for ``details.body``, ``details.plainTextBody`` or ``details.isPlaintext`` no longer throw an exception, instead the compose window chooses the matching ``details.body`` or ``details.plainTextBody`` value and ignores the other.
         */
        function setComposeDetails(tabId: number, details: ComposeDetails): Promise<any>;

        /**
         * Returns a {@link compose.ComposeDictionaries} object, listing all installed dictionaries, including the information whether they are currently enabled or not.
         */
        function getActiveDictionaries(tabId: number): Promise<ComposeDictionaries>;
        ...
        /**
         * Gets the content of a {@link compose.ComposeAttachment} as a {@link File} object.
         * @param id The unique identifier for the attachment.
         */
        function getAttachmentFile(id: number): Promise<File>;
        ...
        /**
         * Updates the name and/or the content of an attachment in the message being composed in the specified tab. If the specified attachment is a cloud file attachment and the associated provider failed to update the attachment, the function will throw an _ExtensionError_.
         */
         ...
         */
        function saveMessage(tabId: number, options?: _SaveMessageOptions): Promise<_SaveMessageReturnReturn>;
         ...
         * @param details The current state of the compose window. This is functionally the same as calling the {@link compose.getComposeDetails} function.
         */
        const onBeforeSend: WebExtEvent<
            (
                tab: tabs.Tab,
                details: ComposeDetails,
            ) => {
                ...
                /**
                 * Updates the compose window. This is functionally the same as calling the {@link compose.setComposeDetails} function.
                 */
        ...
        const onAfterSend: WebExtEvent<(tab: tabs.Tab, sendInfo: _OnAfterSendSendInfo) => void>;

        /** Fired when saving a message as draft or template succeeded or failed. */
        const onAfterSave: WebExtEvent<(tab: tabs.Tab, saveInfo: _OnAfterSaveSaveInfo) => void>;

        /** Fired when an attachment is added to a message being composed. */
        const onAttachmentAdded: WebExtEvent<(tab: tabs.Tab, attachment: ComposeAttachment) => void>;

        /** Fired when an attachment is removed from a message being composed. */
        const onAttachmentRemoved: WebExtEvent<(tab: tabs.Tab, attachmentId: number) => void>;

        /** Fired when the user changes the identity that will be used to send a message being composed. */
        const onIdentityChanged: WebExtEvent<(tab: tabs.Tab, identityId: string) => void>;

        /** Fired when the state of the message composer changed. */
        const onComposeStateChanged: WebExtEvent<(tab: tabs.Tab, state: ComposeState) => void>;

        /** Fired when one or more dictionaries have been activated or deactivated. */
        const onActiveDictionariesChanged: WebExtEvent<(tab: tabs.Tab, dictionaries: ComposeDictionaries) => void>;
    }
    ...
    namespace composeAction {
        ...
        /**
         * Pixel data for an image. Must be an {@link ImageData} object (for example, from a {@link Canvas} element).
         */
        type ImageDataType = ImageData;

        /**
         * A _dictionary object_ to specify multiple {@link ImageData} objects in different sizes, so the icon does not have to be scaled for a device with a different pixel density. Each entry is a _name-value_ pair with _value_ being an {@link ImageData} object, and _name_ its size. Example: [ImageDataDictionary.json](https://raw.githubusercontent.com/thundernest/webext-docs/latest-mv2/includes/ImageDataDictionary.json)See the MDN documentation about choosing icon sizes  for more information on this.
         */
        ...
        interface _GetBadgeTextDetails {
            /**
        ...
        interface _GetBadgeBackgroundColorDetails {
            /**
        ...
        function getBadgeText(details: _GetBadgeTextDetails): Promise<string>;
    ...
    namespace folders {
        ...
        const onCreated: WebExtEvent<(createdFolder: MailFolder) => void>;

        /** Fired when a folder has been renamed. */
        const onRenamed: WebExtEvent<(originalFolder: MailFolder, renamedFolder: MailFolder) => void>;

        /** Fired when a folder has been moved. */
        const onMoved: WebExtEvent<(originalFolder: MailFolder, movedFolder: MailFolder) => void>;

        /** Fired when a folder has been copied. */
        const onCopied: WebExtEvent<(originalFolder: MailFolder, copiedFolder: MailFolder) => void>;
         ...
         */
        const onFolderInfoChanged: WebExtEvent<(folder: MailFolder, folderInfo: MailFolderInfo) => void>;
    }
    ...
    namespace identities {
         ...
         */
        const onCreated: WebExtEvent<(identityId: string, identity: MailIdentity) => void>;

        /** Fired when an identity has been removed from an account. */
        const onDeleted: WebExtEvent<(identityId: string) => void>;

        /**
         * Fired when one or more properties of an identity have been modified. The returned {@link identities.MailIdentity} includes only the changed values.
         */
        const onUpdated: WebExtEvent<(identityId: string, changedValues: MailIdentity) => void>;
    }
    ...
    namespace mailTabs {
         ...
         * **Note:** ``sortType`` and ``sortOrder`` depend on each other, so both should be present, or neither.
         */
        type _MailTabSortOrder = 'none' | 'ascending' | 'descending';

        type _MailTabViewType = 'ungrouped' | 'groupedByThread' | 'groupedBySortType';
         ...
         * @param tabId ID of the requested mail tab. Throws if the requested tab is not a mail tab.
         */
         ...
         * @param [tabId] Defaults to the active tab of the current window.
         */
        function getSelectedMessages(tabId?: number): Promise<messages.MessageList>;
        ...
        function setQuickFilter(properties: _SetQuickFilterProperties): Promise<any>;
        /**
         * Sets the Quick Filter user interface based on the options specified.
         * @param tabId Defaults to the active tab of the current window.
         */
        function setQuickFilter(tabId: number, properties: _SetQuickFilterProperties): Promise<any>;

        /* mailTabs events */
        /** Fired when the displayed folder changes in any mail tab. */
        const onDisplayedFolderChanged: WebExtEvent<(tab: tabs.Tab, displayedFolder: folders.MailFolder) => void>;

        /** Fired when the selected messages change in any mail tab. */
        const onSelectedMessagesChanged: WebExtEvent<(tab: tabs.Tab, selectedMessages: messages.MessageList) => void>;
    }
    ...
    namespace menus {
        ...
        interface OnShowData {
            ...
            /** Will be present for elements with a _src_ URL. **Note:** Host permission is required. */
            ...
            /**
             * An identifier of the clicked content element, if any. Use {@link menus.getTargetElement} in the page to find the corresponding element.
             */
         ...
         * @param targetElementId The identifier of the clicked element, available as ``info.targetElementId`` in the {@link menus.onShown} and {@link menus.onClicked} events.
         */
        ...
        /**
         * Fired when a menu is shown. The extension can add, modify or remove menu items and call {@link menus.refresh} to update the menu.
         ...
         */
        const onShown: WebExtEvent<(info: OnShowData, tab: tabs.Tab) => void>;
    ...
    namespace messageDisplay {
        ...
        const onMessageDisplayed: WebExtEvent<(tab: tabs.Tab, message: messages.MessageHeader) => void>;
         ...
         */
        const onMessagesDisplayed: WebExtEvent<(tab: tabs.Tab, messages: messages.MessageHeader[]) => void>;
    }
    ...
    namespace messageDisplayAction {
        ...
        interface _SetTitleDetails {
            /**
             * A string the messageDisplayAction button should display as its label and when moused over. Cleared by setting it to ``null`` or an empty string (title defined the manifest will be used).
             */
            title: string | null;
            /** Sets the title only for the given tab. */
            tabId?: number | undefined;
        ...
        interface _SetLabelDetails {
            /**
             * A string the messageDisplayAction button should use as its label, overriding the defined title. Can be set to an empty string to not display any label at all. If the containing toolbar is configured to display text only, its title will be used. Cleared by setting it to ``null``.
             */
            label: string | null;
            /** Sets the label only for the given tab. */
            tabId?: number | undefined;
        ...
        /**
         * Fired when a messageDisplayAction button is clicked. This event will not fire if the messageDisplayAction has a popup. This is a user input event handler. For asynchronous listeners some restrictions  apply.
         */
        const onClicked: WebExtEvent<(tab: tabs.Tab, info?: OnClickData) => void>;
    }
    ...
    namespace messages {
        ...
        interface MessagePart {
            ...
            /**
             * The size of this part. The size of _message/*_ parts is not the actual message size (on disc), but the total size of its decoded body parts, excluding headers.
             */
            size?: number | undefined;
        }

        /**
         * Message properties used in {@link messages.update} and {@link messages.import}. They can also be monitored by {@link messages.onUpdated}.
         */
        ...
        /**
         * Deletes messages permanently, or moves them to the trash folder (honoring the account's deletion behavior settings). Deleting external messages will throw an _ExtensionError_. The ``skipTrash`` parameter allows immediate permanent deletion, bypassing the trash folder. **Note**: Consider using {@link messages.move} to manually move messages to the account's trash folder, instead of requesting the overly powerful permission to actually delete messages. The account's trash folder can be extracted as follows: [getTrash.js](https://raw.githubusercontent.com/thundernest/webext-docs/latest-mv2/includes/messages/getTrash.js)
        ...
        const onUpdated: WebExtEvent<(message: MessageHeader, changedProperties: MessageProperties) => void>;

        /** Fired when messages have been moved. */
        const onMoved: WebExtEvent<(originalMessages: MessageList, movedMessages: MessageList) => void>;

        /** Fired when messages have been copied. */
        const onCopied: WebExtEvent<(originalMessages: MessageList, copiedMessages: MessageList) => void>;
    ...
    namespace spacesToolbar {
        ...
        interface ButtonProperties {
            ...
            /**
             * Specifies dark and light icons for the spaces toolbar button to be used with themes: The ``light`` icons will be used on dark backgrounds and vice versa. At least the set for _16px_ icons should be specified. The set for _32px_ icons will be used on screens with a very high pixel density, if specified.
             */
    ...
    namespace tabs {
        ...
        interface Tab {
            /**
             * The ID of the tab. Tab IDs are unique within a session. Under some circumstances a Tab may not be assigned an ID. Tab ID can also be set to {@link tabs.TAB_ID_NONE} for apps and devtools windows.
             */
            id?: number | undefined;
        ...
        type UpdatePropertyName = 'favIconUrl' | 'status' | 'title';
        ...
        /**
         * Fired when a tab is moved within a window. Only one move event is fired, representing the tab the user directly moved. Move events are not fired for the other tabs that must move in response. This event is not fired when a tab is moved between windows. For that, see {@link tabs.onDetached}.
         */
    ...
    namespace theme {
         ...
         * @param [windowId] The window for which we want the theme.
         */
        function getCurrent(windowId?: number): Promise<any>;

        /**
         * Make complete updates to the theme. Resolves when the update has completed.
         * @param details The properties of the theme to update.
         */
        function update(details: _manifest.ThemeType): Promise<any>;
        /**
         * Make complete updates to the theme. Resolves when the update has completed.
         * @param windowId The id of the window to update. No id updates all windows.
         * @param details The properties of the theme to update.
         */
        function update(windowId: number, details: _manifest.ThemeType): Promise<any>;

        /**
         * Removes the updates made to the theme.
         * @param [windowId] The id of the window to reset. No id resets all windows.
         */
        function reset(windowId?: number): Promise<any>;
    ...
    namespace windows {
        ...
        interface Window {
            ...
            height?: number | undefined;
            /**
             * Array of {@link tabs.Tab} objects representing the current tabs in the window. Only included if requested by {@link windows.get}, {@link windows.getCurrent}, {@link windows.getAll} or {@link windows.getLastFocused}, and the optional {@link windows.GetInfo} parameter has its ``populate`` member set to ``true``.
             */
        ...
        interface GetInfo {
            ...
            /**
             * If set, the {@link windows.Window} returned will be filtered based on its type. Supported by {@link windows.getAll} only, ignored in all other functions.
             */
        ...
        /**
         * Fired when the currently focused window changes. Will be {@link windows.WINDOW_ID_NONE}, if all windows have lost focus. **Note:** On some Linux window managers, WINDOW_ID_NONE will always be sent immediately preceding a switch from one window to another.
    ...
    /**
     * Use the `messenger.browserSettings` API to control global settings of the browser.
     *
    ...
    /**
     * Use the `messenger.cookies` API to query and modify cookies, and to be notified when they change.
     *
     * Permissions: `cookies`
     *
     * Not allowed in: Content scripts, Devtools pages
    ...
    namespace downloads {
        ...
        interface _DownloadOptions {
            ...
            /**
             * Use a file-chooser to allow the user to select a filename. If the option is not specified, the file chooser will be shown only if the Firefox "Always ask you where to save files" option is enabled (i.e. the pref `messenger.download.useDownloadDir` is set to `false`).
             */
        ...
        /* downloads functions */
        /**
         * Download a URL. If the URL uses the HTTP[S] protocol, then the request will include all cookies currently set for its hostname. If both `filename` and `saveAs` are specified, then the Save As dialog will be displayed, pre-populated with the specified `filename`. If the download started successfully, `callback` will be called with the new DownloadItem's `downloadId`. If there was an error starting the download, then `callback` will be called with `downloadId=undefined` and messenger.extension.lastError will contain a descriptive string. The error strings are not guaranteed to remain backwards compatible between releases. You must not parse it.
        ...
        /**
         * Pause the download. If the request was successful the download is in a paused state. Otherwise messenger.extension.lastError contains an error message. The request will fail if the download is not active.
         * @param downloadId The id of the download to pause.
         */
        function pause(downloadId: number): Promise<void>;

        /**
         * Resume a paused download. If the request was successful the download is in progress and unpaused. Otherwise messenger.extension.lastError contains an error message. The request will fail if the download is not active.
        ...
        /**
         * Retrieve an icon for the specified download. For new downloads, file icons are available after the onCreated event has been received. The image returned by this function while a download is in progress may be different from the image returned after the download is complete. Icon retrieval is done by querying the underlying operating system or toolkit depending on the platform. The icon that is returned will therefore depend on a number of factors including state of the download, platform, registered file types and visual theme. If a file icon cannot be determined, messenger.extension.lastError will contain an error message.
    ...
    /**
     * The `messenger.events` namespace contains common types used by APIs dispatching events to notify you when something interesting happens.
     *
     * Not allowed in: Content scripts, Devtools pages
     *
    ...
    /**
     * The `messenger.extension` API has utilities that can be used by any extension page. It includes support for exchanging messages between an extension and its content scripts or between extensions, as described in detail in Message Passing.
     *
    ...
    /**
     * The `messenger.extensionTypes` API contains type declarations for WebExtensions.
     *
     * Not allowed in: Content scripts, Devtools pages
     *
    ...
    /**
     * Use the `messenger.i18n` infrastructure to implement internationalization across your whole app or extension.
     *
    ...
    /**
     * Use the `messenger.idle` API to detect when the machine's idle state changes.
     *
     * Permissions: `idle`
     *
     * Not allowed in: Content scripts, Devtools pages
    ...
    /**
     * The `messenger.management` API provides ways to manage the list of extensions that are installed and running.
     *
     * Not allowed in: Content scripts, Devtools pages
     *
    ...
    namespace privacy {
        /**
         * Use the `messenger.privacy` API to control usage of the features in the browser that can affect a user's privacy.
         *
         * Permissions: `privacy`
         *
         * Not allowed in: Content scripts, Devtools pages
    ...
    /**
     * Use the `messenger.runtime` API to retrieve the background page, return details about the manifest, and listen for and respond to events in the app or extension lifecycle. You can also use this API to convert the relative path of URLs to fully-qualified URLs.
     *
    ...
    /**
     * Use the `messenger.storage` API to store, retrieve, and track changes to user data.
     *
     * Permissions: `storage`
     *
    ...
    /**
     * Use the `messenger.webNavigation` API to receive notifications about the status of navigation requests in-flight.
     *
    ...
    /**
     * Use the `messenger.webRequest` API to observe and analyze traffic and to intercept, block, or modify requests in-flight.
     *
